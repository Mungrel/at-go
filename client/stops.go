...
// StopsByTripID gets a list of stops, filtered by stop ID from the AT GTFS API
func (client *Client) StopsByTripID(tripID string) ([]*Stop, error) {
	url := baseURL + "/v2/gtfs/stops/tripId/" + tripID
